    ...
    <div className="bg-white isolate">
      ...
      <main>
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="mt-0">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2  lg:grid-flow-col-dense">
                <div className="lg:pl-8 lg:pt-4 px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
                  <div className="lg:max-w-lg">
                    <h2 className="text-base font-semibold leading-7 text-indigo-600">
                      Deploy faster
                    </h2>
